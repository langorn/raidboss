...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.post_count'
        db.add_column(u'teammate_instance', 'post_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.post_count'
        db.delete_column(u'teammate_instance', 'post_count')
